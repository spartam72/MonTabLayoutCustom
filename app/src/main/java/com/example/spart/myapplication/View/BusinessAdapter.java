...
import com.example.spart.myapplication.DetailActivityBusiness;
...
public class BusinessAdapter extends RecyclerView.Adapter<BusinessAdapter.MyViewHolder> {
    ...
    private final ArrayList<ArticleBusiness> results;

    public BusinessAdapter(Context context, ArrayList<ArticleBusiness> results) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.articleItemWindow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), DetailActivityBusiness.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                ArticleBusiness newsData=results.get(position);
